...
<head>
    ...
    <title>Landos (Su orden de servicio)</title>
                                ...
                                <table bgcolor="#ffffff" class="es-header-body" align="center" cellpadding="0"
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <!--[if mso]><table style="width:520px" cellpadding="0" cellspacing="0"><tr><td style="width:192px" valign="top"><![endif]-->
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        class="adapt-img"
                                                                        src="https://vxrkoe.stripocdn.email/content/guids/CABINET_bd241d2b67004e2d2c7d5f3d05ef9a70/images/logo1_b3S.png"
                                                                        alt
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <h5 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#3d85c6"
                                                                        class="brand">Gracias por la preferencia</h5>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <h3 class="product-name"
                                                                        style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333"> {{$servicio->nombre}} </h3>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#999999;font-size:14px"
                                                                        class="product-description">{{ $servicio->descripcion }}</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td align="left"
                                                                                ...
                                                                                <span class="es-button-border"
                                                                                    style="border-style:solid;border-color:#2CB543;background:#2CB543;border-width:0px 0px 2px 0px;display:inline-block;border-radius:18px;width:auto"><a
                                                                                        href=""
                                                                                        class="es-button es-button-1"
                                                                                        target="_blank"
                                                                                        style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;border-style:solid;border-color:#31CB4B;border-width:10px 20px;display:inline-block;background:#31CB4B;border-radius:18px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center">
                                                                                        Total a pagar</a></span>
                                                                            </td>
